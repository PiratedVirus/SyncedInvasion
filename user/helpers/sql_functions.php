...
//        echo 'total unattempted are' .($totalQuestions - $attempted);
    echo '<p class="homeSubHeader"><span class="text-info">Attempted Questions : </span><b>'. $attempted .'</b> <span style="margin-left: 20px;" class="text-info"> Unttempted Questions : </span><b>'. ($unAttempted-1) .'</b></p>';

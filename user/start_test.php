                            ...
                            <div class="buttons col-md-12">
                                ...
                                <div class="row mtMobile">
                                    <div class="tagBtn text-center col-md-1 col-xs-4 ">
                                        ...
                                        <button id="detagQ" style="display: none;" class="customBtn tag btn btn-default">DeTag
                                        </button>
                                    </div>
                                    ...
                                    <div id="preview" class=" text-center col-md-1 col-xs-4">
                                        <button class="customBtn btn btn-default"><span class="hideOnMobile">Preview &<br>Submit</span>
                                            <span data-toggle="tooltip" data-placement="top" title="Preview & Submit"
                                                  class="viewOnMobile">P & S</span></button>
                                    </div>
                                    ...
                                    <div class="infoHolder">
                                        ...
                                        <div class="text-center col-md-1  col-xs-6  margin-left-captions">
                                            <span class="tagCount counterNumb">0</span><br><span
                                                class="counterCaption"> Tagged</span>
                                        </div>
                                        <div class="text-center col-md-2  col-xs-6  margin-left-captions">
                                            <span class="attempTagCount counterNumb">0</span><br><span
                                                class="counterCaption text-center"> Tagged Attempted</span>
                                        </div>
                                        <div class="text-center col-md-1  col-xs-6  margin-left-captions">
                                            <span class="unattemptCount counterNumb"><?php echo getQuestionsCount($conn, $_SESSION['TestTitle']) ?></span><br><span
                                                class="planSubHeader text-center">Unattempted</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div style="display: none;" class="container resultBtnHolder">
                    <div class="row flexCenter">
                        <div class="col-md-12 theEnd text-center">
                            ...
                            <p id="resultText">Clicked <b>Get My Result</b> to view Test score, number of Correct and Incorrect
                                responses, attempted and unanswered questions. To get detailed graphical analysis click <b>View
                                    Graphical Analysis</b> button. All this can be access later from <b>'Results & Analysis'</b>
                                menu. </p>
